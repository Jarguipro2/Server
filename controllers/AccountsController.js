...
module.exports =
    class AccountsController extends require('./Controller') {
        ...
        head() {
            this.response.JSON(null, this.usersRepository.ETag);
        }
        ...
        index(id) {
            if (!isNaN(id)) {
                ...
                if (user != null) {
                    let userClone = { ...user };
                    userClone.Password = "********";
                    this.response.JSON(userClone, this.usersRepository.ETag);
                }
            }
            else {
                ...
                this.response.JSON(usersClone, this.usersRepository.ETag);
            }
        }
